...
Med.InventorySelector = msg['EventData']['B340B'].toString();

if(Med.InventorySelector == "N"){
...
Script.Barcode = Script.RxNumber+Script.RefillNumber;//msg['EventData']['PMSBarcode'].toString();//Script.TransactionId
