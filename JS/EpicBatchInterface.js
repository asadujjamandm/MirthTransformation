...
Address.AddressType = "Primary";//msg['PID']['PID.11']['PID.11.7'].toString().trim();
Address.Primary = "true";
//Address.Id =null;

var Addresses = [];
//if(((Address.Street1 !== null || Address.Street1 !== "") || (Address.Street2 !== null || Address.Street2 !== "")) && 
...
//logger.info("Patient_ID" + _values_list);
...
//	Addresses[i].PatientID = Patient.Id;
//}

//for(i=0;i<PhoneNumbers.length;i++){
	//PhoneNumbers[i].PatientID = Patient.Id;
//}
