...
Address.AddressType = "Home";//msg['PID']['PID.11']['PID.11.7'].toString().trim();
...
//PatientFullName.Text = msg['FillData']['DispenseData']['PatientName']['FirstName'].toString()+" "+ msg['FillData']['DispenseData']['PatientName']['MiddleInitial'].toString() +" "+ msg['FillData']['DispenseData']['PatientName']['LastName'].toString();
...
//PrescriberFullName.Text = msg['FillData']['PrescriberName']['FirstName'].toString()+" "+msg['FillData']['PrescriberName']['MiddleInitial'].toString()+" "+msg['FillData']['PrescriberName']['LastName'].toString();
...
//PharmacistFullName.Text = msg['FillData']['PharmacistName']['FirstName'].toString()+" "+msg['FillData']['PharmacistName']['MiddleInitial'].toString()+" "+msg['FillData']['PharmacistName']['LastName'].toString();
...
//PrescriberCityStateZip.Text = msg['FillData']['PrescriberAddress']['City'].toString()+" "+msg['FillData']['PrescriberAddress']['State'].toString() +" "+msg['FillData']['PrescriberAddress']['Zip'].toString();
...
//PatientCityStateZip.Text = msg['FillData']['PatientAddress']['City'].toString()+" "+ msg['FillData']['PatientAddress']['State'].toString()+" "+msg['FillData']['PatientAddress']['Zip'].toString();
...
//StoreCityStateZip.Text = msg['FillData']['StoreAddress']['City'].toString()+" "+ msg['FillData']['StoreAddress']['State'].toString()+" "+msg['FillData']['StoreAddress']['Zip'].toString();
...
//SecondaryStoreCityStateZip.Text = msg['FillData']['SecondaryStoreAddress']['City'].toString()+" "+msg['FillData']['SecondaryStoreAddress']['State'].toString() +" "+msg['FillData']['SecondaryStoreAddress']['Zip'].toString();
...
//PrescriberAddress.Text = msg['FillData']['PrescriberAddress']['Address1'].toString();
...
//PatientAddress.Text = msg['FillData']['PatientAddress']['Address1'].toString();
...
Med.MedIdType = 0;
Med.Name = IsNullOrEmpty(msg['FillData']['DispenseData']['DispensedDrugName'].toString().trim()) ? msg['FillData']['DispenseData']['AltDispensedDrugName'].toString().trim() : msg['FillData']['DispenseData']['DispensedDrugName'].toString().trim();
Med.InventorySelector = IsNullOrEmpty(msg['FillData']['DispenseData']['InventorySelector'].toString().trim()) ? 0 :msg['FillData']['DispenseData']['InventorySelector'].toString().trim();
...
Script.RefillNumber = msg['FillData']['DispenseData']['RefillNumber'].toString();
Script.TransactionId = msg['FillData']['DispenseData']['RxId'].toString();
Script.Barcode = msg['FillData']['WorkFlowBarcode'].toString();
...
Script.DaysSupply = IsNullOrEmpty(msg['FillData']['DaysSupply'].toString()) ? 0 : parseInt(msg['FillData']['DaysSupply'].toString());
Script.HOA = null;
...
if(IsNullOrEmpty(Facility.Id) && IsNullOrEmpty(Facility.Name)) {
	Facility = null;
}
...
Batch.Id = BatchId;
Batch.TransmissionId = msg['Msg_Header']['Msg_ID'].toString();
