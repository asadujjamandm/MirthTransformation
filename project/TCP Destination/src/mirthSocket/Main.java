...
class Main {     
    public static void main(String args[]) throws Exception{
        TcpDestination tcpDestination  = new TcpDestination("10.6.72.59", 2000);     //"10.12.72.6", 8071 "10.6.72.59", 2000
        ...
        String data = tcpDestination.ReadDataFromFile();
        data = tcpDestination.SendToServer(data);
